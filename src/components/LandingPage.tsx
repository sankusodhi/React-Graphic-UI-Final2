      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-x-4 md:space-y-0">
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="bg-yellow-500 text-black px-6 py-2  font-medium sm:w-full md:w-auto"
          >
            Book a Demo
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="hover:bg-white border-white text-white hover:text-black px-12 py-2  font-medium border-2 sm:w-full md:w-auto"
          >
            Sign up
          </motion.button>
        </div>
